...
export default function RegisterModal() {
    ...
    const footerContent = (
        <div className="text-neutral-400 text-center mt-4">
            <p>
                ...
                <span onClick={onToggle} className="ml-2 text-white cursor-pointer hover:underline">
                    Sign in
                </span>
            </p>
        </div>
    ...
    return (
        <Modal actionDisabled={isLoading} isOpen={registerModal.isOpen} title="Create an account" actionLabel="Register" onClose={registerModal.onClose} onSubmit={onSubmit} body={bodyContent} footer={footerContent} />
